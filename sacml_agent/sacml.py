...
from .sacml_impl import SACMLImpl
    

class SACML(AlgoBase):
    r""" 
    ...
    _impl: Optional[SACMLImpl]
    # additional attributes for SAC+ML
    ...
    def _update(self, batch: TransitionMiniBatch) -> Dict[str, float]:
        ...
        # baseline update for SAC+ML
        baseline_loss = self._impl.update_baseline(batch)
        metrics.update({"baseline_loss": baseline_loss})
